...
create table public.vacancy_stop_list (
...
create index idx_vacancy_stop_list_vacancy on public.vacancy_stop_list (vacancy_id);
-- Нормалізований пошук за ПІБ (для порівняння з кандидатом).
create index idx_vacancy_stop_list_name on public.vacancy_stop_list (vacancy_id, lower(full_name));
...
create index idx_vacancy_stop_list_tenant on public.vacancy_stop_list (tenant_id);
